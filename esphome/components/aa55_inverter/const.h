...
const std::unordered_map<SENSOR_TYPE, FUNCTION_CODE> MAP_SENSOR_RESPONSE_SOURCE = {
    ...
    {SENSOR_TYPE::COUNTRY_CODE, FUNCTION_CODE::RUN_INFO_RESPONSE},

    // Query ID info sensors
    {SENSOR_TYPE::MODEL, FUNCTION_CODE::ID_INFO_RESPONSE},
    {SENSOR_TYPE::SERIAL_NUMBER, FUNCTION_CODE::ID_INFO_RESPONSE}};

const std::unordered_map<FUNCTION_CODE, INPUT_TYPE> MAP_RESPONSE_INPUT = {
    {FUNCTION_CODE::START_INVERTER_RESPONSE, INPUT_TYPE::START_STOP},
    {FUNCTION_CODE::STOP_INVERTER_RESPONSE, INPUT_TYPE::START_STOP},
    {FUNCTION_CODE::RECONNECT_GRID_RESPONSE, INPUT_TYPE::RECONNECT_GRID},
    {FUNCTION_CODE::ADJUST_POWER_RESPONSE, INPUT_TYPE::ADJUST_POWER}};
}  // namespace aa55_const
}  // namespace esphome
